(function (moment$1,leaflet) {
    ...
    var IconSidebarWidget = function (_EventTarget) {
        inherits(IconSidebarWidget, _EventTarget);

        function IconSidebarWidget(container, options) {
            classCallCheck(this, IconSidebarWidget);

            var _this = possibleConstructorReturn(this, (IconSidebarWidget.__proto__ || Object.getPrototypeOf(IconSidebarWidget)).call(this));
        ...
        createClass(IconSidebarWidget, [{
            ...
            value: function _renderTabs(options) {
                ...
                Object.keys(this._panes).map(function (id) {
                    return extend({ id: id }, _this4._panes[id]);
                }).sort(function (a, b) {
        ...
        return new Promise(function (resolve) {
            ...
            window.Catalog.resultsContainer = window.Catalog.searchSidebar.setPane('results', {
                createTab: createTab({
                    ...
                    hint: T$e.getText('results.title')
                })
            });
            ...
            window.Catalog.favoritesContainer = window.Catalog.searchSidebar.setPane('favorites', {
                createTab: createTab({
                    ...
                    hint: T$e.getText('results.favorites')
                })
            });
...
//# sourceMappingURL=scanex-edda.45fc37f7b70e349f289fe02ebbfeb273bf058cb5.min.js.map