...
const pageFileName = './permalink.html'
let rxJS = new RegExp('permalink\.[a-f0-9]+\.min\.js');
...
const data = page.replace(rxJS, jsFileName);
// data = data.replace(rxCSS, cssFileName);
